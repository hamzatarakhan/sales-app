          ...
          children: [
            Expanded(
              child: ListView(
                ...
                children: [
                  Text('Order for ${widget.visit.customerName}', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        SizedBox(width: 32, child: Text('$qty', textAlign: TextAlign.center, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700))),
