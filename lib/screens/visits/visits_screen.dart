      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          children: [
            ...
            Text(context.t('quick_tools'), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800)),
            ...
            const SizedBox(height: 22),
            Text('${context.t('today_visits')} · $filterLabel', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800)),
            const SizedBox(height: 12),
