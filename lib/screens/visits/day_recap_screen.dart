      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text(context.t('sales'), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w800)),
            ...
            Text(context.t('nav_visits'), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w800)),
            const SizedBox(height: 10),
            SectionCard(
              child: Column(
                children: [
