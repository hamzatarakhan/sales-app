      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            SectionCard(
              child: Column(
                ...
                children: [
                  ...
                  Text('${fmtMoney(widget.invoice.due)} JOD', style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
                ],
              ),
            ),
            const SizedBox(height: 18),
            Text(context.t('payment_method'), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
            ...
            const SizedBox(height: 18),
            Text(context.t('amount'), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
            const SizedBox(height: 10),
            TextField(
              controller: _amount,
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(context.t('payment_recorded'), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
